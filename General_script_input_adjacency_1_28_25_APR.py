...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan 28 15:18:34 2025

@author: aplaza-rodriguez
"""

##Generalized_code: This script will take as input an adjacency matrix and all model parameters and output simulation data and model calculations.
...
print('determine phase lag between switches and oscillators as "set", "uniform", "zero"')
beta_opt=str(input())

##determine ratio of switches to oscillators
print('input ratio of switches to oscillators: options (input one of these floats): "0.25" "0.50," "0.75"')
ratio=float(input())
...
##read in csv file containing adjacency matrix
print("input file path for csv file containing adjacency matrix")
file_adj = input()
##test:/Users/aplaza-rodriguez/Downloads/insilico_size100_1.csv
adj_matrix = np.genfromtxt(file_adj, delimiter=',')


G1=nx.from_numpy_array(adj_matrix, edge_attr="weight") ##use a single graph for all the types of nodes
...
##determine how many switches vs oscillators to assigne
for i in range(0, int(G1.number_of_nodes())):
    if assignment2[i] < np.quantile(assignment2, ratio):
...
figure0.savefig("full_G_graph_node_colors.pdf" )
...
##determine if there will be a phase lag
if beta_opt=="zero":
    Beta=np.zeros(num_switches)

if beta_opt=="uniform":
    Beta=np.random.uniform(0, 2*np.pi, num_switches)
...
G_p_K_r_theta_subgraph_log = open("G_p_fixed_increasing_k_rtheta_10_01_24_subgraph_parameters_log.txt", "a")
G_p_K_r_theta_subgraph_log.write("rep-%01d"%(rep))
G_p_K_r_theta_subgraph_log.write("\n")
...
print(C1) 
print("\n")  
G_p_K_r_theta_subgraph_log.write("oscillator_oscillator_subgraph")
G_p_K_r_theta_subgraph_log.write("\n")
G_p_K_r_theta_subgraph_log.write("C1")
G_p_K_r_theta_subgraph_log.write(" ")
G_p_K_r_theta_subgraph_log.write(str(C1))
G_p_K_r_theta_subgraph_log.write("\n") 
...
if nx.is_connected(oscillator_oscillator_subgraph):
    ...
    print(l1)
    print("\n")
    G_p_K_r_theta_subgraph_log.write("l1")
    G_p_K_r_theta_subgraph_log.write(" ")
    G_p_K_r_theta_subgraph_log.write(str(l1))
    G_p_K_r_theta_subgraph_log.write("\n")
    ...
    G_p_K_r_theta_subgraph_log.write("Max_infromation_centrality1")
    G_p_K_r_theta_subgraph_log.write(" ")
    G_p_K_r_theta_subgraph_log.write(str(Max_InfCen1))
    G_p_K_r_theta_subgraph_log.write("\n") 
    G_p_K_r_theta_subgraph_log.write("nodes_with_max_information_centrality1")
    G_p_K_r_theta_subgraph_log.write(" ")
    G_p_K_r_theta_subgraph_log.write(str(nodes_max_InfCen1))
    G_p_K_r_theta_subgraph_log.write("\n") 
    ...
    G_p_K_r_theta_subgraph_log.write("<l1>")
    G_p_K_r_theta_subgraph_log.write(" ")
    G_p_K_r_theta_subgraph_log.write("N/A")
    G_p_K_r_theta_subgraph_log.write("\n")
    print('N/A')
    G_p_K_r_theta_subgraph_log.write("Max_infromation_centrality1")
    G_p_K_r_theta_subgraph_log.write(" ")
...
G_p_K_r_theta_subgraph_log.write("kmax1 nodes")
G_p_K_r_theta_subgraph_log.write(" ")
G_p_K_r_theta_subgraph_log.write(str(kmax1_nodes))
G_p_K_r_theta_subgraph_log.write("\n")   

G_p_K_r_theta_subgraph_log.write("kmax1")
G_p_K_r_theta_subgraph_log.write(" ")
G_p_K_r_theta_subgraph_log.write(str(kmax1))
G_p_K_r_theta_subgraph_log.write("\n")   
...
G_p_K_r_theta_subgraph_log.write("nodes_with_max_degree_centrality1")
G_p_K_r_theta_subgraph_log.write(" ")
G_p_K_r_theta_subgraph_log.write(str(nodes_max_degcen1))
G_p_K_r_theta_subgraph_log.write("\n")   

G_p_K_r_theta_subgraph_log.write("Max_degree_centrality1")
G_p_K_r_theta_subgraph_log.write(" ")
G_p_K_r_theta_subgraph_log.write(str(Max_degcen1))
G_p_K_r_theta_subgraph_log.write("\n") 
...
G_p_K_r_theta_subgraph_log.write("nodes_with_max_betweenness_centrality1")
G_p_K_r_theta_subgraph_log.write(" ")
G_p_K_r_theta_subgraph_log.write(str(nodes_max_betCen1))
G_p_K_r_theta_subgraph_log.write("\n")   

G_p_K_r_theta_subgraph_log.write("Max_betweennes_centrality1")
G_p_K_r_theta_subgraph_log.write(" ")
G_p_K_r_theta_subgraph_log.write(str(Max_betCen1))
G_p_K_r_theta_subgraph_log.write("\n") 
...
print(louvain_modularity1)
print("\n")
G_p_K_r_theta_subgraph_log.write("louvain_modularity1")
G_p_K_r_theta_subgraph_log.write(" ")
G_p_K_r_theta_subgraph_log.write(str(louvain_modularity1))
G_p_K_r_theta_subgraph_log.write("\n") 
...
print(average_degree_of_graph1) 
print("\n")   
G_p_K_r_theta_subgraph_log.write("average_degree_of_graph1")
G_p_K_r_theta_subgraph_log.write(" ")
G_p_K_r_theta_subgraph_log.write(str(average_degree_of_graph1))
G_p_K_r_theta_subgraph_log.write("\n")     
...
print(C3)   
print("\n") 
G_p_K_r_theta_subgraph_log.write("switch_switch_subgraph")
G_p_K_r_theta_subgraph_log.write("\n")
G_p_K_r_theta_subgraph_log.write("C3")
G_p_K_r_theta_subgraph_log.write(" ")
G_p_K_r_theta_subgraph_log.write(str(C3))
G_p_K_r_theta_subgraph_log.write("\n") 
...
if nx.is_connected(switch_switch_subgraph):
    ...
    print(l3)
    print("\n")
    G_p_K_r_theta_subgraph_log.write("<l3>")
    G_p_K_r_theta_subgraph_log.write(" ")
    G_p_K_r_theta_subgraph_log.write(str(l3))
    G_p_K_r_theta_subgraph_log.write("\n")
    ...
    print(Max_InfCen3)
    G_p_K_r_theta_subgraph_log.write("Max_infromation_centrality3")
    G_p_K_r_theta_subgraph_log.write(" ")
    G_p_K_r_theta_subgraph_log.write(str(Max_InfCen3))
    G_p_K_r_theta_subgraph_log.write("\n") 

    G_p_K_r_theta_subgraph_log.write("nodes_with_max_information_centrality3")
    G_p_K_r_theta_subgraph_log.write(" ")
    G_p_K_r_theta_subgraph_log.write(str(nodes_max_InfCen3))
    G_p_K_r_theta_subgraph_log.write("\n") 
    ...
    G_p_K_r_theta_subgraph_log.write("\n")
    print('N/A')
    G_p_K_r_theta_subgraph_log.write("Max_information_centrality3")
    G_p_K_r_theta_subgraph_log.write(" ")
    G_p_K_r_theta_subgraph_log.write("N/A")
    G_p_K_r_theta_subgraph_log.write("\n")
    print('N/A')
...
G_p_K_r_theta_subgraph_log.write("kmax3 nodes")
G_p_K_r_theta_subgraph_log.write(" ")
G_p_K_r_theta_subgraph_log.write(str(kmax3_nodes))
G_p_K_r_theta_subgraph_log.write("\n")   

G_p_K_r_theta_subgraph_log.write("kmax3")
G_p_K_r_theta_subgraph_log.write(" ")
G_p_K_r_theta_subgraph_log.write(str(kmax3))
G_p_K_r_theta_subgraph_log.write("\n")   
...
G_p_K_r_theta_subgraph_log.write("nodes_with_max_degree_centrality3")
G_p_K_r_theta_subgraph_log.write(" ")
G_p_K_r_theta_subgraph_log.write(str(nodes_max_degcen3))
G_p_K_r_theta_subgraph_log.write("\n")   

G_p_K_r_theta_subgraph_log.write("Max_degree_centrality3")
G_p_K_r_theta_subgraph_log.write(" ")
G_p_K_r_theta_subgraph_log.write(str(Max_degcen3))
G_p_K_r_theta_subgraph_log.write("\n") 
...
G_p_K_r_theta_subgraph_log.write("nodes_with_max_betweenness_centrality3")
G_p_K_r_theta_subgraph_log.write(" ")
G_p_K_r_theta_subgraph_log.write(str(nodes_max_betCen3))
G_p_K_r_theta_subgraph_log.write("\n")   

G_p_K_r_theta_subgraph_log.write("Max_betweennes_centrality3")
G_p_K_r_theta_subgraph_log.write(" ")
G_p_K_r_theta_subgraph_log.write(str(Max_betCen3))
G_p_K_r_theta_subgraph_log.write("\n") 
...
print(louvain_modularity3)
print("\n")
G_p_K_r_theta_subgraph_log.write("louvain_modularity3")
G_p_K_r_theta_subgraph_log.write(" ")
G_p_K_r_theta_subgraph_log.write(str(louvain_modularity3))
G_p_K_r_theta_subgraph_log.write("\n") 
...
print(average_degree_of_graph3)  
print("\n")
G_p_K_r_theta_subgraph_log.write("average_degree_of_graph3")
G_p_K_r_theta_subgraph_log.write(" ")
G_p_K_r_theta_subgraph_log.write(str(average_degree_of_graph3))
G_p_K_r_theta_subgraph_log.write("\n") 
...
fourier_correlation_analysys_G=open("G_fourier_analysis_10_30_24.tsv", "a")
fourier_correlation_analysys_G.write('frequency domain xf')
fourier_correlation_analysys_G.write("\t")
fourier_correlation_analysys_G.write("r_theta_fft")
fourier_correlation_analysys_G.write("\t")
fourier_correlation_analysys_G.write("psi_fft")
if max(r_x_list)> 0: 
    fourier_correlation_analysys_G.write("\t")
    fourier_correlation_analysys_G.write("rx_fft")
    fourier_correlation_analysys_G.write("\t")
    fourier_correlation_analysys_G.write("<x(t)> fft")
fourier_correlation_analysys_G.write("\n")


for t in range(len(xf)):
    fourier_correlation_analysys_G.write(str(xf[t]))
    fourier_correlation_analysys_G.write("\t")
    fourier_correlation_analysys_G.write(str(r_theta_fft[t]))
    fourier_correlation_analysys_G.write("\t")
    fourier_correlation_analysys_G.write(str(psi_fft[t]))
 
    if max(r_x_list)> 0: 
        fourier_correlation_analysys_G.write("\t")
        fourier_correlation_analysys_G.write(str(rx_fft[t]))
        fourier_correlation_analysys_G.write("\t")
        fourier_correlation_analysys_G.write(str(x_fft[t]))
    fourier_correlation_analysys_G.write("\n")
...
G_p_K_r_theta = open("G_p_fixed_increasing_k_rtheta_10_28_24.tsv", "a")
G_p_K_r_theta.write("rep-%01d"%(rep))
G_p_K_r_theta.write("\n")
G_p_K_r_theta.write("C")
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write("<l>")
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write("max_InfCen")
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write("nodes_with_max_information_centrality")
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write("G kmax node")
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write("kmax node type")
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write("G kmax")
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write("nodes_with_max_degree_centrality")
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write("max_degree_centrality")
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write("nodes_with_max_betweeness_centrality")
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write("max_betweeness_centrality")
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write("louvain modularity")
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write("G <k>")
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write("K_t_init")
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write("omega_0")
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write("delta_scale")
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write("K_max")
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write("Kx_theta")
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write("Kxx")
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write("eta")
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write("tau")
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write("beta_l")
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write("<r_x_eq>")
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write("<r_theta_eq>")
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write("num_switches")
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write("num_oscillators")
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write("mean_x_init")
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write("SD_x_init")
G_p_K_r_theta.write("\n")
...
if nx.is_connected(G1):
    ...
    G_p_K_r_theta.write(str(Max_InfCen))
    G_p_K_r_theta.write("\t") 

    G_p_K_r_theta.write(str(nodes_max_InfCen))
    G_p_K_r_theta.write("\t")
    
else:
    G_p_K_r_theta.write("N/A")
    G_p_K_r_theta.write("\t")
    print('N/A')
    G_p_K_r_theta.write("N/A")
    G_p_K_r_theta.write("\t")
...
G_p_K_r_theta.write(str(kmax_nodes))
G_p_K_r_theta.write("\t") 
G_p_K_r_theta.write(str(kmax_node_type))
G_p_K_r_theta.write("\t")  
G_p_K_r_theta.write(str(kmax))
G_p_K_r_theta.write("\t")   
...
G_p_K_r_theta.write(str(nodes_max_degcen))
G_p_K_r_theta.write("\t")   


G_p_K_r_theta.write(str(Max_degcen))
G_p_K_r_theta.write("\t") 
...
G_p_K_r_theta.write(str(nodes_max_betCen))
G_p_K_r_theta.write("\t")   


G_p_K_r_theta.write(str(Max_betCen))
G_p_K_r_theta.write("\t") 
...
print(louvain_modularity)
print("\n") 
G_p_K_r_theta.write(str(louvain_modularity))
G_p_K_r_theta.write("\t")  
...
print("\n") 
G_p_K_r_theta.write(str(average_degree_of_graph))
G_p_K_r_theta.write("\t")  

##export simulation params and calculated model and graph proeprties to a tsv file
##determine the beta export option
if beta_opt=="zero":
    set_Beta=0

if beta_opt=="uniform":
   set_Beta="random_unif_zero_2pi"
...
G_hub_order_params=open("G_hub_order_params.tsv", "a")
G_hub_order_params.write("switch-switch subgraph hub complex <rx_eq>")
G_hub_order_params.write("\t")
G_hub_order_params.write("oscillator-oscillator hub subgraph complex <rtheta_eq>")
G_hub_order_params.write("\t")
G_hub_order_params.write("full graph hub hub complex <rx_eq>")
G_hub_order_params.write("\t")
G_hub_order_params.write("full graph hub rtheta complex <rx_eq>")
G_hub_order_params.write("\n")

if len(np.shape(rx_hub_switch_subgraph))>1:
    G_hub_order_params.write(str(np.mean(np.mean(rx_hub_switch_subgraph[:-1000], axis=1), axis=0)))
    G_hub_order_params.write("\t")
else:
    G_hub_order_params.write(str(np.mean(rx_hub_switch_subgraph[:-1000])))
    G_hub_order_params.write("\t")

if len(np.shape(r_theta_hub_oscillator_subgraph))>1:
    G_hub_order_params.write(str(np.mean(np.mean(r_theta_hub_oscillator_subgraph[:-1000], axis=1), axis=0)))
    G_hub_order_params.write("\t")
else:
    G_hub_order_params.write(str(np.mean(r_theta_hub_oscillator_subgraph[:-1000])))
    G_hub_order_params.write("\t")
    
if len(np.shape(rx_hub_overall))>1:
    G_hub_order_params.write(str(np.mean(np.mean(rx_hub_overall[:-1000], axis=1), axis=0)))
    G_hub_order_params.write("\t")
else:
    G_hub_order_params.write(str(np.mean(rx_hub_overall[:-1000])))
    G_hub_order_params.write("\t")

if len(np.shape(r_theta_hub_overall))>1:
    G_hub_order_params.write(str(np.mean(np.mean(r_theta_hub_overall[:-1000], axis=1), axis=0)))
    G_hub_order_params.write("\n")
else:
    G_hub_order_params.write(str(np.mean(r_theta_hub_overall[:-1000])))
    G_hub_order_params.write("\n")


G_p_K_r_theta.write(str(K_t_init))
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write(str(mean_omega))
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write(str(sigma_omega))
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write(str(K_max))
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write(str(Kx_theta))
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write(str(Kxx))
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write(str(eta))
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write(str(tau))
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write(str(set_Beta))
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write(str(time_avg_r_x_eq))
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write(str(time_avg_r_theta_eq))
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write(str(num_switches))
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write(str(num_oscillators))
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write(str(mean_x_init))
G_p_K_r_theta.write("\t")
G_p_K_r_theta.write(str(SD_x_init))
G_p_K_r_theta.write("\n")
...
order_param_corr_G=open("G_order_param_and_correlation_timeseries_analysis_10_30_24.tsv", "a")
order_param_corr_G.write('model time units')
order_param_corr_G.write('\t')
order_param_corr_G.write('K(t)')
order_param_corr_G.write('\t')
order_param_corr_G.write("r_theta")
order_param_corr_G.write("\t")
order_param_corr_G.write("r_x")
order_param_corr_G.write("\t")
order_param_corr_G.write("r_theta_autocorr")
if max(r_x_list)> 0: 
    order_param_corr_G.write("\t")
    order_param_corr_G.write("rx_autocorr")
    order_param_corr_G.write("\t")
    order_param_corr_G.write("order_param_cross_corr")
order_param_corr_G.write("\n")


for t in range(T):
    order_param_corr_G.write(str(time[t]))
    order_param_corr_G.write("\t")
    order_param_corr_G.write(str(K_t[t]))
    order_param_corr_G.write('\t')
    order_param_corr_G.write(str(r_theta_list[t]))
    order_param_corr_G.write("\t")
    order_param_corr_G.write(str(r_x_list[t]))
    order_param_corr_G.write("\t")
    order_param_corr_G.write(str(r_theta_auto_corr[t]))
 
    if max(r_x_list)> 0: 
        order_param_corr_G.write("\t")
        order_param_corr_G.write(str(rx_auto_corr[t]))
        order_param_corr_G.write("\t")
        order_param_corr_G.write(str(order_param_crosscorr[t]))
    order_param_corr_G.write("\n")

G_p_K_r_theta.close()
G_p_K_r_theta_subgraph_log.close()
fourier_correlation_analysys_G.close()
G_hub_order_params.close()
order_param_corr_G.close()

##export the generated graph in multi-line adjacency format for further use
nx.generate_gexf(G1, "Graph_gexf.gexf")
