...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct  1 10:18:23 2024
...
G1=nx.watts_strogatz_graph(n=total_nodes,k=avg_k, p=p) ##use a single graph for all the types of nodes
...
SW_p_K_r_theta.write("\t")
SW_p_K_r_theta.write("louvain_modularity")
SW_p_K_r_theta.write("\t")
