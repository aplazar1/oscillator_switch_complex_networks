...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan 21 12:17:19 2025
...
##testing params
#200,5,2.5,2.5,0.8,1,4,100,10,3.2,0,-100,5,1,1.5,1,0.01,50
...
figure0.savefig("full_LFR_graph_node_colors.pdf" )        
...
LFR_p_K_r_theta.write("\t")
LFR_p_K_r_theta.write("omega_0")
LFR_p_K_r_theta.write("\t")
LFR_p_K_r_theta.write("delta_scale")
LFR_p_K_r_theta.write("\t")
...
LFR_p_K_r_theta.write("\t")
LFR_p_K_r_theta.write(str(omega_0))
LFR_p_K_r_theta.write("\t")
LFR_p_K_r_theta.write(str(delta_scale))
LFR_p_K_r_theta.write("\t")
