...
figure0.savefig("full_ER_graph_node_colors.pdf" )          ##10/31  
...
if nx.is_connected(oscillator_oscillator_subgraph):
    ...
    ER_p_K_r_theta_subgraph_log.write("Max_infromation_centrality1")
    ER_p_K_r_theta_subgraph_log.write(" ")
    ER_p_K_r_theta_subgraph_log.write(str(Max_InfCen1))
    ER_p_K_r_theta_subgraph_log.write("\n") 
    ER_p_K_r_theta_subgraph_log.write("nodes_with_max_information_centrality1")
    ER_p_K_r_theta_subgraph_log.write(" ")
    ER_p_K_r_theta_subgraph_log.write(str(nodes_max_InfCen1))
    ER_p_K_r_theta_subgraph_log.write("\n") 
...
if nx.is_connected(switch_switch_subgraph):
    ...
    print(Max_InfCen3)
    ER_p_K_r_theta_subgraph_log.write("Max_infromation_centrality3")
    ER_p_K_r_theta_subgraph_log.write(" ")
    ER_p_K_r_theta_subgraph_log.write(str(Max_InfCen3))
    ER_p_K_r_theta_subgraph_log.write("\n") 

    ER_p_K_r_theta_subgraph_log.write("nodes_with_max_information_centrality3")
    ER_p_K_r_theta_subgraph_log.write(" ")
    ER_p_K_r_theta_subgraph_log.write(str(nodes_max_InfCen3))
    ER_p_K_r_theta_subgraph_log.write("\n") 
    ...
    ER_p_K_r_theta_subgraph_log.write("\n")
    print('N/A')
    ER_p_K_r_theta_subgraph_log.write("Max_information_centrality3")
    ER_p_K_r_theta_subgraph_log.write(" ")
    ER_p_K_r_theta_subgraph_log.write("N/A")
    ER_p_K_r_theta_subgraph_log.write("\n")
    print('N/A')
...
fourier_correlation_analysys_ER=open("ER_fourier_analysis_10_30_24.tsv", "a")
fourier_correlation_analysys_ER.write('frequency domain xf')
fourier_correlation_analysys_ER.write("\t")
fourier_correlation_analysys_ER.write("r_theta_fft")
fourier_correlation_analysys_ER.write("\t")
fourier_correlation_analysys_ER.write("psi_fft")
if max(r_x_list)> 0: 
    fourier_correlation_analysys_ER.write("\t")
    fourier_correlation_analysys_ER.write("rx_fft")
    fourier_correlation_analysys_ER.write("\t")
    fourier_correlation_analysys_ER.write("<x(t)> fft")
fourier_correlation_analysys_ER.write("\n")


for t in range(len(xf)):
    fourier_correlation_analysys_ER.write(str(xf[t]))
    fourier_correlation_analysys_ER.write("\t")
    fourier_correlation_analysys_ER.write(str(r_theta_fft[t]))
    fourier_correlation_analysys_ER.write("\t")
    fourier_correlation_analysys_ER.write(str(psi_fft[t]))
 
    if max(r_x_list)> 0: 
        fourier_correlation_analysys_ER.write("\t")
        fourier_correlation_analysys_ER.write(str(rx_fft[t]))
        fourier_correlation_analysys_ER.write("\t")
        fourier_correlation_analysys_ER.write(str(x_fft[t]))
    fourier_correlation_analysys_ER.write("\n")
...
ER_p_K_r_theta.write("\t")
ER_p_K_r_theta.write("max_InfCen")
ER_p_K_r_theta.write("\t")
ER_p_K_r_theta.write("nodes_with_max_information_centrality")
ER_p_K_r_theta.write("\t")
ER_p_K_r_theta.write("G kmax node")
ER_p_K_r_theta.write("\t")
ER_p_K_r_theta.write("kmax node type")
ER_p_K_r_theta.write("\t")
...
ER_p_K_r_theta.write("\t")
ER_p_K_r_theta.write("mean_omega")
ER_p_K_r_theta.write("\t")
ER_p_K_r_theta.write("sigma_omega")
ER_p_K_r_theta.write("\t")
...
if nx.is_connected(G1):
    ...
    ER_p_K_r_theta.write(str(Max_InfCen))
    ER_p_K_r_theta.write("\t") 

    ER_p_K_r_theta.write(str(nodes_max_InfCen))
    ER_p_K_r_theta.write("\t")
...
ER_p_K_r_theta.write("\t") 
ER_p_K_r_theta.write(str(kmax_node_type))
ER_p_K_r_theta.write("\t")  
...
ER_hub_order_params.write("switch-switch subgraph hub complex <rx_eq>")
ER_hub_order_params.write("\t")
ER_hub_order_params.write("oscillator-oscillator hub subgraph complex <rtheta_eq>")
ER_hub_order_params.write("\t")
ER_hub_order_params.write("full graph hub hub complex <rx_eq>")
ER_hub_order_params.write("\t")
ER_hub_order_params.write("full graph hub rtheta complex <rx_eq>")
ER_hub_order_params.write("\n")

if len(np.shape(rx_hub_switch_subgraph))>1:
    ER_hub_order_params.write(str(np.mean(np.mean(rx_hub_switch_subgraph[:-1000], axis=1), axis=0)))
    ER_hub_order_params.write("\t")
else:
    ER_hub_order_params.write(str(np.mean(rx_hub_switch_subgraph[:-1000])))
    ER_hub_order_params.write("\t")

if len(np.shape(r_theta_hub_oscillator_subgraph))>1:
    ER_hub_order_params.write(str(np.mean(np.mean(r_theta_hub_oscillator_subgraph[:-1000], axis=1), axis=0)))
    ER_hub_order_params.write("\t")
else:
    ER_hub_order_params.write(str(np.mean(r_theta_hub_oscillator_subgraph[:-1000])))
    ER_hub_order_params.write("\t")
    
if len(np.shape(rx_hub_overall))>1:
    ER_hub_order_params.write(str(np.mean(np.mean(rx_hub_overall[:-1000], axis=1), axis=0)))
    ER_hub_order_params.write("\t")
else:
    ER_hub_order_params.write(str(np.mean(rx_hub_overall[:-1000])))
    ER_hub_order_params.write("\t")

if len(np.shape(r_theta_hub_overall))>1:
    ER_hub_order_params.write(str(np.mean(np.mean(r_theta_hub_overall[:-1000], axis=1), axis=0)))
    ER_hub_order_params.write("\n")
else:
    ER_hub_order_params.write(str(np.mean(r_theta_hub_overall[:-1000])))
    ER_hub_order_params.write("\n")


ER_p_K_r_theta.write(str(K_t_init))
ER_p_K_r_theta.write("\t")
ER_p_K_r_theta.write(str(mean_omega))
ER_p_K_r_theta.write("\t")
ER_p_K_r_theta.write(str(sigma_omega))
ER_p_K_r_theta.write("\t")
...
order_param_corr_ER=open("ER_order_param_and_correlation_timeseries_analysis_10_30_24.tsv", "a")
order_param_corr_ER.write('model time units')
order_param_corr_ER.write('\t')
order_param_corr_ER.write("K_t")
order_param_corr_ER.write("\t")
order_param_corr_ER.write("r_theta")
order_param_corr_ER.write("\t")
order_param_corr_ER.write("r_x")
order_param_corr_ER.write("\t")
order_param_corr_ER.write("r_theta_autocorr")
if max(r_x_list)> 0: 
    order_param_corr_ER.write("\t")
    order_param_corr_ER.write("rx_autocorr")
    order_param_corr_ER.write("\t")
    order_param_corr_ER.write("order_param_cross_corr")
order_param_corr_ER.write("\n")


for t in range(T):
    order_param_corr_ER.write(str(time[t]))
    order_param_corr_ER.write("\t")
    order_param_corr_ER.write(str(K_t[t]))
    order_param_corr_ER.write("\t")
    order_param_corr_ER.write(str(r_theta_list[t]))
    order_param_corr_ER.write("\t")
    order_param_corr_ER.write(str(r_x_list[t]))
    order_param_corr_ER.write("\t")
    order_param_corr_ER.write(str(r_theta_auto_corr[t]))
 
    if max(r_x_list)> 0: 
        order_param_corr_ER.write("\t")
        order_param_corr_ER.write(str(rx_auto_corr[t]))
        order_param_corr_ER.write("\t")
        order_param_corr_ER.write(str(order_param_crosscorr[t]))
    order_param_corr_ER.write("\n")
